...
class RPRESS_Tracking {
	...
	public function admin_notice() {
		...
		if (
			...
			$extensions_url = 'https://fooditems.com/fooditems/?utm_source=' . $source . '&utm_medium=admin&utm_term=notice&utm_campaign=RPRESSUsageTracking';
			echo '<div class="updated"><p>';
			echo sprintf( __( 'Allow RestroPress to track plugin usage? Opt-in to tracking and our newsletter and immediately be emailed a discount to the RPRESS shop, valid towards the <a href="%s" target="_blank">purchase of extensions</a>. No sensitive data is tracked.', 'restro-press' ), $extensions_url );
			echo '&nbsp;<a href="' . esc_url( $optin_url ) . '" class="button-secondary">' . __( 'Allow', 'restro-press' ) . '</a>';
			echo '&nbsp;<a href="' . esc_url( $optout_url ) . '" class="button-secondary">' . __( 'Do not allow', 'restro-press' ) . '</a>';
			echo '</p></div>';
		}
	}
