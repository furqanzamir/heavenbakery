	...
	<div class="postbox">
		...
		<div class="inside">
			<form id="rpress-debug-log" method="post">
				<p><?php _e( 'Use this tool to help debug RestroPress functionality. Developers may use the <a href="https://github.com/fooditems/restro-press/blob/master/includes/class-rpress-logging.php">RPRESS_Logging class</a> to record debug data.', 'restro-press' ); ?></p>
