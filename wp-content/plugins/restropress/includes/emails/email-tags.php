...
function rpress_setup_email_tags() {
	...
	$email_tags = array(
		array(
			'tag'         => 'fooditem_list',
			'description' => __( 'A list of fooditem links for each fooditem purchased', 'rpress' ),
			'function'    => 'rpress_email_tag_fooditem_list'
		),
		array(
			'tag'         => 'file_urls',
			'description' => __( 'A plain-text list of fooditem URLs for each fooditem purchased', 'rpress' ),
