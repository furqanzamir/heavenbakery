...
function rpress_setup_email_tags() {
	...
	$email_tags = array(
		array(
			'tag'         => 'fooditem_list',
			'description' => __( 'A list of fooditem links for each fooditem purchased', 'restro-press' ),
			'function'    => 'text/html' == RPRESS()->emails->get_content_type() ? 'rpress_email_tag_fooditem_list' : 'rpress_email_tag_fooditem_list_plain'
		),
		array(
			'tag'         => 'file_urls',
			'description' => __( 'A plain-text list of fooditem URLs for each fooditem purchased', 'restro-press' ),
			'function'    => 'rpress_email_tag_file_urls'
		),
		array(
			'tag'         => 'name',
 ...
 * A list of fooditem links for each fooditem purchased
 *
...
/**
 * Email template tag: fooditem_list
 * A list of fooditem links for each fooditem purchased in plaintext
 *
 * @since 1.0
 * @param int $payment_id
 *
