 ...
 * Description: Restaurant food ordering system for WordPress
 * Author: Magnigenie
...
if ( ! class_exists( 'Restro_Press' ) ) :

/**
 * Main Restro_Press Class.
 *
 * @since 1.0
 */
final class Restro_Press {
	/** Singleton *************************************************************/

	/**
	 * @var Restro_Press The one true Restro_Press
	 * @since  1.0.0
	 */
	...
	/**
	 * Main Restro_Press Instance.
	 *
	 * Insures that only one instance of Restro_Press exists in memory at any one
	 * time. Also prevents needing to define globals all over the place.
	 *
	 * @since  1.0.0
	 * @static
	 * @staticvar array $instance
	 * @uses Restro_Press::setup_constants() Setup the constants needed.
	 * @uses Restro_Press::includes() Include the required files.
	 * @uses Restro_Press::load_textdomain() load the language files.
	 * @see RPRESS()
	 * @return object|Restro_Press The one true Restro_Press
	 */
	public static function instance() {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Restro_Press ) ) {
			self::$instance = new Restro_Press;
...
/**
 * The main function for that returns Restro_Press
 *
 * The main function responsible for returning the one true Restro_Press
 ...
 *
 * @since  1.0.0
 * @return object|Restro_Press The one true Restro_Press Instance.
 */
function RPRESS() {
	return Restro_Press::instance();
}
